...
From NeuralNetInterp.MaxOfTwoNumbersUndertrainedSimpler Require Import Parameters Model Model.Instances.
...
Module Model.
  ...
  Definition unembed (resid : tensor resid_shape A) : tensor (s ::' cfg.d_vocab_out) A
    ...
    Proof using Type. intros; apply loss_fn_Proper_dep; t. Qed.
