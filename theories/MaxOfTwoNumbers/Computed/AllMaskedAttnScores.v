...
Time Definition all_tokens_masked_attn_scores_concrete_eq : all_tokens_masked_attn_scores_concrete = prev := extract_eq all_tokens_masked_attn_scores_concrete_value. (*
